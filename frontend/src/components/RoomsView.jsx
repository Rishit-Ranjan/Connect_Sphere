            ...
            {rooms.map((room) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-2.5 px-3.5 py-3 rounded-2xl text-xs text-left transition-all font-semibold ${
                    isSelected
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <span
                      className={`block text-[9px] font-medium truncate mt-0.5 ${
