...
const ChatMessage = ({ message, secret, currentUser, allUsers }) => {
    ...
    return (<div className={`flex items-start gap-2 ${isFromCurrentUser ? 'justify-end' : 'justify-start'}`}>
            ...
            <div className={`flex flex-col max-w-xs md:max-w-md lg:max-w-lg rounded-2xl overflow-hidden ${isFromCurrentUser ? 'bg-primary text-white rounded-br-none' : 'bg-gray-200 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-bl-none'}`}>
