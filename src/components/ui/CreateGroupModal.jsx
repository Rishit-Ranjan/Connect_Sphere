            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md transform animate-fade-in-scale flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 space-y-6 overflow-y-auto">
                    <div>
                        ...
                        <input type="text" id="groupName" value={groupName} onChange={(e) => setGroupName(e.target.value)} className="block w-full px-4 py-3 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-slate-700 dark:to-slate-700/50 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-50" placeholder="My awesome group" disabled={isCreating}/>
                    </div>
                    <div>
