...
const ManageRoomModal = ({ room, allUsers, onClose, onSaveMembers, onSaveSettings, onDeleteRoom }) => {
    const [activeTab, setActiveTab] = useState(room.roomPrivacy === 'invite_only' ? 'members' : 'settings');
    ...
    return (<div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-secondary rounded-2xl shadow-2xl w-full max-w-lg transform animate-fade-in-scale flex flex-col max-h-[90vh]">
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center space-x-2">
                {room.roomPrivacy === 'invite_only' && <TabButton label="Members" value="members"/>}
        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          {/* Members Tab */}
          {activeTab === 'members' && room.roomPrivacy === 'invite_only' && (<div className="space-y-4">
              <div className="relative">
                ...
                <div className="relative">
                    ...
                    <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Search for users to add..." className="w-full pl-10 pr-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 border-2 border-transparent focus:border-primary rounded-full focus:outline-none focus:ring-0 transition" disabled={isSaving}/>
                </div>
